(function () {
  ...
  var I18N = {
    en: {
      ...
      "edu.role": "Cybersecurity · 3rd year",
      "edu.meta": "Cryptography, networking, information security. Based in Germany.",
      "skills.eyebrow": "02 — Skills", "skills.title": "What I work with.",
      "skills.all": "All", "skills.front": "Frontend", "skills.sec": "Security", "skills.tools": "Tools",
      "projects.eyebrow": "03 — Projects", "projects.title": "Things I built.", "projects.all": "View all on GitHub",
      "proj.view": "View repo →", "proj.swipe": "← swipe →",
      "course.eyebrow": "04 — University coursework", "course.title": "Academic work.",
      ...
      "lang.eyebrow": "05 — Languages", "lang.title": "Languages I speak.", "lang.native": "Native",
      "lang.ru": "Russian", "lang.uk": "Ukrainian", "lang.en": "English", "lang.de": "German",
      ...
      "game.eyebrow": "07 — Mini-game", "game.title": "Access code",
      "game.sub": "Repeat the sequence of flashes. Each level the code grows. Can you reach 10?",
      "game.idle": "Press \u201CStart\u201D to break into the system.", "game.start": "Start", "game.restart": "Restart", "game.again": "Play again",
      "game.watch": "Watch closely\u2026", "game.your": "Your turn · level", "game.right": "Correct \u2713",
      "game.win": "\uD83C\uDF89 System cracked! All 10 levels cleared.", "game.lose": "Access denied at level",
      "game.code": "Code:", "game.repeat": "repeat it on the tiles (level",
      "contacts.eyebrow": "08 — Contact", "contacts.title": "Let\u2019s connect",
      "contacts.lead": "Open to projects, internships and good conversations.", "contacts.email": "Email",
      "footer.tag": "Cybersecurity · Frontend"
    },
    de: {
      "meta.title": "Daniil Barilotti — Portfolio",
      "nav.about": "Über mich", "nav.skills": "Skills", "nav.projects": "Projekte",
      "nav.coursework": "Studienarbeiten", "nav.languages": "Sprachen", "nav.contacts": "Kontakt",
      "hero.tagline": "Ich baue Produkte, die im Kern sicher und angenehm zu benutzen sind.",
      "about.eyebrow": "01 — Über mich", "about.title": "Wer ich bin & wo ich studiere.",
      ...
      "edu.role": "Cybersicherheit · 3. Jahr",
      "edu.meta": "Kryptografie, Netzwerke, Informationssicherheit. Wohnhaft in Deutschland.",
      "skills.eyebrow": "02 — Skills", "skills.title": "Womit ich arbeite.",
      "skills.all": "Alle", "skills.front": "Frontend", "skills.sec": "Sicherheit", "skills.tools": "Tools",
      "projects.eyebrow": "03 — Projekte", "projects.title": "Was ich gebaut habe.", "projects.all": "Alle auf GitHub ansehen",
      "proj.view": "Repo ansehen →", "proj.swipe": "← wischen →",
      "course.eyebrow": "04 — Studienarbeiten", "course.title": "Akademische Arbeiten.",
      ...
      "lang.eyebrow": "05 — Sprachen", "lang.title": "Sprachen, die ich spreche.", "lang.native": "Muttersprache",
      "lang.ru": "Russisch", "lang.uk": "Ukrainisch", "lang.en": "Englisch", "lang.de": "Deutsch",
      "motiv.eyebrow": "06 — Motivation",
      "motiv.quote": "Ich will Produkte bauen, denen Menschen vertrauen — sicher von Grund auf und bis ins kleinste Detail durchdacht.",
      "game.eyebrow": "07 — Mini-Spiel", "game.title": "Zugangscode",
      "game.sub": "Wiederhole die Abfolge der Blitze. Mit jedem Level wird der Code länger. Schaffst du 10?",
      "game.idle": "Drücke \u201EStart\u201C, um ins System einzudringen.", "game.start": "Start", "game.restart": "Neu starten", "game.again": "Nochmal spielen",
      "game.watch": "Gut aufpassen\u2026", "game.your": "Du bist dran · Level", "game.right": "Richtig \u2713",
      "game.win": "\uD83C\uDF89 System geknackt! Alle 10 Level geschafft.", "game.lose": "Zugriff verweigert auf Level",
      "game.code": "Code:", "game.repeat": "wiederhole ihn auf den Kacheln (Level",
      "contacts.eyebrow": "08 — Kontakt", "contacts.title": "Lass uns vernetzen",
      "contacts.lead": "Offen für Projekte, Praktika und gute Gespräche.", "contacts.email": "E-Mail",
  ...
  /* ======================= Projects ======================= */
  var PROJECTS = [
    { name: "2048_game", tag: "JavaScript", url: "https://github.com/DaniilBarilotti/2048_game",
      desc: { en: "Classic 2048 puzzle implemented in vanilla JavaScript.", de: "Klassisches 2048-Puzzle in reinem JavaScript." } },
    { name: "miami-landing", tag: "SCSS", url: "https://github.com/DaniilBarilotti/miami-landing",
      desc: { en: "Responsive landing page built with semantic markup and SCSS.", de: "Responsive Landingpage mit semantischem Markup und SCSS." } },
    { name: "phone-catalog", tag: "TypeScript", url: "https://github.com/DaniilBarilotti/phone-catalog",
      desc: { en: "Phone catalog app with filtering, sorting and a cart.", de: "Handy-Katalog mit Filter, Sortierung und Warenkorb." } },
    { name: "todo-app", tag: "TypeScript", url: "https://github.com/DaniilBarilotti/todo-app",
      desc: { en: "Task manager with clean state handling and a tidy UI.", de: "Aufgabenverwaltung mit sauberem State-Handling und aufgeräumter UI." } }
  ];

  /* ======================= language ======================= */
  var lang = "en";
  try { var saved = localStorage.getItem("site_lang"); if (saved && I18N[saved]) lang = saved; } catch (e) {}
  ...
  function renderProjects() {
    ...
    PROJECTS.forEach(function (p) {
      ...
      a.className = "proj-card"; a.href = p.url; a.target = "_blank"; a.rel = "noopener";
      a.innerHTML =
  ...
  function onScroll() { if (window.scrollY > 80) nav.classList.add("show"); else nav.classList.remove("show"); }
  ...
  var PALETTES = [
    ["#5b8cff", "#b06bff"], // indigo → violet (default)
    ["#36d1dc", "#5b86e5"], // cyan → blue
    ["#43e97b", "#38f9d7"], // green → teal
    ["#ff6fd8", "#ff9a6c"], // pink → orange
    ["#a06bff", "#ff7eb0"]  // violet → pink
  ];
  var palIndex = 0;
  ...
  paletteBtn.addEventListener("click", function (e) {
    ...
    // beautiful ripple: a circle in the new color grows from the button and covers the screen
    ...
    // swap the real palette under the cover, then fade the ripple away
  ...
  function step() { var card = track.querySelector(".proj-card"); return card ? card.offsetWidth + 18 : 320; }
  ...
  var mIo = new IntersectionObserver(function (es) {
    es.forEach(function (e) {
      ...
      var iv = setInterval(function () {
        ...
        cur.insertAdjacentText("beforebegin", txt.charAt(i)); i++;
      }, 36);
    });
  }, { threshold: .5 });
  ...
  function beep(i, ok) {
    ...
    try {
      ...
      o.frequency.value = ok === false ? 110 : freqs[i]; o.type = "sine";
  ...
  function light(i, ok) { tiles[i].classList.add("lit"); beep(i, ok); setTimeout(function () { tiles[i].classList.remove("lit"); }, 320); }
  function playSeq() {
    accepting = false; statusEl.textContent = t("game.watch");
    seq.forEach(function (k, idx) { setTimeout(function () { light(k); }, 600 + idx * 620); });
    setTimeout(function () { accepting = true; statusEl.innerHTML = t("game.your") + " <b>" + level + "</b>"; }, 600 + seq.length * 620 + 200);
  }
  function nextLevel() {
    input = []; level++; seq.push(Math.floor(Math.random() * 4));
    if (reduce) { statusEl.innerHTML = t("game.code") + " <b>" + seq.join(" ") + "</b> · " + t("game.repeat") + " " + level + ")"; accepting = true; }
    else playSeq();
  }
  function win() { playing = false; accepting = false; statusEl.textContent = t("game.win"); startBtn.textContent = t("game.again");
    tiles.forEach(function (x, i) { setTimeout(function () { light(i); }, i * 120); }); }
  function lose() { playing = false; accepting = false; statusEl.innerHTML = t("game.lose") + " <b>" + level + "</b>."; startBtn.textContent = t("game.restart"); }
  ...
  tiles.forEach(function (tl, i) {
    tl.setAttribute("tabindex", "0"); tl.setAttribute("role", "button");
    tl.addEventListener("click", function () { handleTile(i); });
    tl.addEventListener("keydown", function (e) { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); handleTile(i); } });
  });
  startBtn.addEventListener("click", function () { seq = []; input = []; level = 0; playing = true; startBtn.textContent = t("game.restart"); nextLevel(); });
  ...
  function startRain() {
    if (rainOn || reduce) return; rainOn = true; sizeC(); canvas.classList.add("on");
    var fs = 16, cols = Math.floor(canvas.width / fs), drops = new Array(cols).fill(1);
    var chars = "01\u30A2\u30A4\u30A6\u30A8\u30AA\u30ABabcdef{}<>$#".split("");
    function draw() {
      ctx.fillStyle = "rgba(7,8,12,.08)"; ctx.fillRect(0, 0, canvas.width, canvas.height);
    ...
    draw(); setTimeout(stopRain, 6000);
  }
  function stopRain() { rainOn = false; canvas.classList.remove("on"); cancelAnimationFrame(raf);
  ...
  document.addEventListener("keydown", function (e) { pos = (e.keyCode === code[pos]) ? pos + 1 : 0; if (pos === code.length) { pos = 0; startRain(); } });
